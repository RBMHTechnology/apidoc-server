...
public class ApiDocController {
	...
	String base(@PathVariable String groupId, @PathVariable String artifactId, @PathVariable String version) throws AccessNotAllowedException {
		logger.trace("groupId: {}, artifactId: {}, version: {}. rediret to index.html",
				...
				null);
		ensureValidGroupId(groupId);
		return "redirect:/{groupId}/{artifactId}/{version}/" + repositoryService.getDefaultClassifier() + "/index.html";
	}
	...
	void serve(@PathVariable String groupId,
		...
		try {
			...
			throw new RuntimeException("Error serving '" + subPath + "' for group:" + groupId + ", artifact:"
